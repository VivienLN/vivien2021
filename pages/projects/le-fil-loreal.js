...
export default function Project() {
    return (
        <Layout>
            ...
            <ProjectSummary>
                <p className="mb-4">Le fil est une plateforme développée sur-mesure pour mettre en relation la marque L'Oréal et ses influenceurs. Ceux-ci peuvent s'engager pour des opérations spéciales, devenant ambassadeurs auprès de leur communauté.</p>
