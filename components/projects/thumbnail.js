                ...
                <div className={"overflow-hidden relative " + styles.projectThumbnail }>
                    <Link href={"/projects/" + this.props.project.slug} scroll={false}>
                        <a className={"bg-secondary-darker " + styles.link}>
                            <span className={"pointer-events-none absolute z-10 inset-0 flex flex-col text-center justify-center p-4 filter drop-shadow-xl " + styles.linkText}>
                            ...
                            <PixiImage 
                                ...
                                height={500}
                                alt="" 
                                transitionDelayRatio={.8}
                                transitionDelay={20}
                                transitionMask={ "/images/projects/mask.jpg"}
                                gradientMap={{0: "#000", 0.4: "#068ec3", 1: "#ffec4e"}}
                            />
                        </a>
                    </Link>
                </div>
